...
//  }
  ...
  public double[] minimize(DifferentiableFunction function, double functionTolerance,
      double[] initial) {
...
//    boolean doEval = false;
    ...
    do {
      ...
      try {
        sayln();
//        doEval = (its > 0 && evaluateIters > 0 && its % evaluateIters == 0);
//        if (doEval) {
//          doEvaluation(x);
//        }
        its += 1;
...
//    }
  ...
  //
  //
  // private double[] lineSearchNocedal(DifferentiableFunction dfunc, double[] dir,
   ...
   *
   * if( Double.isNaN(pointList.get(0)[gInd]) ){ // We dont know the gradient at
  ...
  // private double[] zoom(DifferentiableFunction dfunc, double[] x, double[] dir,
  ...
  // }while(true);
  // }
  // private double[] zoom2(DifferentiableFunction dfunc, double[] x, double[] dir,
  // double[] newX, double f0, double g0, double[] bestPoint, double[] endPoint)
  // throws MaxEvaluationsExceeded {
  //
  // double[] newPoint = new double[3];
  ...
  // //sayln();
  //
  // //DifferentiableFunctionTester.test(dfunc, x,1e-4);
  // //System.exit(1);
  ...
  // }
  //
  // private double lineSearchNocedal(DifferentiableFunction dfunc, double[] dir, double[]
