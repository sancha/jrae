...
polarityvars; % file contains words, allSStr, allSNum (4000 reviews)

useTrees = 0;

% randomly initialize We
%%sizeWe = [50  268810];
sizeWe = [50 5000]; %% 8275 words in vocab from 20,000 reviews, 3419 words from 4000 reviews
...
file1 = '../data/rt-polaritydata/goodreviews2.2k.txt';
fid1 = fopen(file1);

%file2 = '../data/rt-polaritydata/rt-polarity.neg';
file2 = '../data/rt-polaritydata/badreviews2.2k.txt';
fid2 = fopen(file2);
...
%save('../data/rt-polaritydata/rt-polarity_pos_ascii_allSNum', 'allSNum', -ascii);
%save('../data/rt-polaritydata/rt-polarity_pos_ascii_allSStr', 'allSStr', -ascii);
